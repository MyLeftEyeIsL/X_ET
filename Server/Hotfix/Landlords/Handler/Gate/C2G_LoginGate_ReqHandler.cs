...
namespace ETHotfix
{
    ...
    {
        protected override async ETTask Run(Session session, C2G_LoginGate_Req request, G2C_LoginGate_Ack response, Action reply)
        {
            ...
            long userId = landlordsGateSessionKeyComponent.Get(request.Key);
            ...
            //Key过期
            landlordsGateSessionKeyComponent.Remove(request.Key);
